 ...
 *
 * ```php
 * $server = new \BetterMessages\React\Socket\TcpServer(8080);
 * ```
 *
 ...
 *
 * ```php
 * $server->on('connection', function (BetterMessages\React\Socket\ConnectionInterface $connection) {
...
final class TcpServer extends EventEmitter implements ServerInterface
{
     ...
     *
     * ```php
     * $server = new \BetterMessages\React\Socket\TcpServer(0);
     ...
     *
     * ```php
     * $server = new \BetterMessages\React\Socket\TcpServer('192.168.0.1:8080');
     * ```
     *
     ...
     *
     * ```php
     * $server = new \BetterMessages\React\Socket\TcpServer('[::1]:8080');
     * ```
     *
     ...
     * $server = new \BetterMessages\React\Socket\TcpServer('127.0.0.1');
     * ```
     *
     ...
     *
     * ```php
     * $first = new \BetterMessages\React\Socket\TcpServer(8080);
     *
     * // throws RuntimeException because port is already in use
     * $second = new \BetterMessages\React\Socket\TcpServer(8080);
     * ```
     *
     ...
     *
     * ```php
     * $server = new \BetterMessages\React\Socket\TcpServer('[::1]:8080', null, array(
     *     'backlog' => 200,
     *     'so_reuseport' => true,
     *     'ipv6_v6only' => true
     * ));
