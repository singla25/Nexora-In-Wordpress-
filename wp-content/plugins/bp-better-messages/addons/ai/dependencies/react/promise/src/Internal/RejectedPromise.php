...
use function BetterMessages\React\Promise\_checkTypehint;
use function BetterMessages\React\Promise\resolve;
use function BetterMessages\React\Promise\set_rejection_handler;
