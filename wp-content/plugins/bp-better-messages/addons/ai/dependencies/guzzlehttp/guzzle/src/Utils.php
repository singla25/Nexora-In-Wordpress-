...
use BetterMessages\GuzzleHttp\Handler\CurlHandler;
use BetterMessages\GuzzleHttp\Handler\CurlMultiHandler;
use BetterMessages\GuzzleHttp\Handler\Proxy;
use BetterMessages\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
    ...
    public static function debugResource($value = null)
    {
        ...
        return \BetterMessages\GuzzleHttp\Psr7\Utils::tryFopen('php://output', 'w');
    }
    /**
     ...
     *
     * @return callable(\BetterMessages\Psr\Http\Message\RequestInterface, array): Promise\PromiseInterface Returns the best handler for the given system.
     *
